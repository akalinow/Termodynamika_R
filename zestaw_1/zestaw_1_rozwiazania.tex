...
Przy jakiej minimalnej liczbie osób prawdopodobieństwo tego, 
że:
\begin{enumerate}[(a)]
...
a) Zagadnienie możemy sformułować następująco:
...
\item k par osób obchodzących urodziny tego samego dnia $\to$ k sukcesów
\end{itemize}   
 Rozkład prawdopodobieństwa liczby par osób obchodzących urodziny tego samego dnia 
...
(c) Istnieje modyfikacja tego zadania: "kluska Buffona" -- rzut igłą, 
która niekoniecznie jest prosta, lecz może mieć dowolny kształt 
(ale taką samą długość $2l$). Co ciekawe, wynik jest identyczny.
