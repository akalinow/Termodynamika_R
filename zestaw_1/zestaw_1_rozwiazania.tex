...
od punktu początkowego po $n$ krokach. Ruch w obu kierunkach jest niezależny,
a kroki zachodzą z takim samym prawdopodobieństwem, 
więc $ p(0|2n) = p(0|2n)$. By być w odległości $x=0$ po $n$ krokach,
...
po $2n$ krokach to:
\begin{align*}
p_{\text{powrót}}(2n) = p(0|2n) \cdot p(0|2n) = \left(\frac{(2n)!}{n! \cdot n!} \cdot \frac{1}{2}^{2n}\right)^2
\end{align*}
...
\begin{align*}
p_{\text{powrót}}(2n) \approx \left(\frac{1}{\sqrt{\pi n}}\right)^2 = \frac{1}{\pi n}
\end{align*}
...
\begin{align*}
P_{\text{powrót}} = \sum_{n=1}^{\infty} p_{\text{powrót}}(2n) \approx \sum_{n=1}^{\infty} \frac{1}{\pi n}
\end{align*}
...
z wielokrotnie powróci do punktu początkowego, czyli conajmnioej jeden powrót jest 
...
\hat{N}_{unbias} = 2 \cdot N_{obs} - 1 = 2 \cdot 60 - 1 = 119
    ...
    \begin{align*}
E[max|N, n] = \frac{n}{n+1} \cdot N = \frac{5}{6} \cdot N
    \end{align*}
